...
//*** To execute the quickstart project.
...
npm install -g gulp
npm install -g gulp-uglify --save-dev
...
npm install -g angular2 rxjs es6-promise es6-shim reflect-metadata zone.js --save
...
npm install -g http-server [: To run a simple server and see our coverage reports.]
npm install -g jasmine-core [: Our testing framework.]
npm install -g karma [: Our test runner.]
npm install -g karma-chrome-launcher [: To launch Google Chrome from Karma.]
npm install -g karma-coverage [: To create Coverage reports.]
npm install -g karma-jasmine [: Karma adapter for Jasmine framework.]
npm install -g remap-istanbul [: To map our coverage in JS files to TypeScript files.]
npm install -g systemjs [: Module loader.]
npm install -g typescript [: TypeScript compiler.]

npm install -g http-server jasmine-core karma karma-chrome-launcher karma-coverage karma-jasmine remap-istanbul systemjs typescript --save-dev
